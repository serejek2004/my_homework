...
public:
    ...
    void get_percent_points()
    {
        float percent_points;
        percent_points = 0;
        percent_points = (number_votes / summary_votes) * 100;
        cout << "Percent votes " << percent_points << " %" << endl;
    }
};
...
private:
    string name_winner;
    int number_votes_winner;

public:
    void candidate_winner(string names_candidates[5], int number_votes[5])
    {
